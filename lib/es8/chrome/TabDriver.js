...
class TabDriver {
	...
	constructor(debuggingPortId, uniqueTabId, options, client, cdpTargetId) {
		this.__closed = false
		...
		this.__debuggingPortId = debuggingPortId
	...
	_close(callback) {
		this.__client.close(() => {
			...
			CDP.Close({ port: this.__debuggingPortId, id: this.__cdpTargetId }, (err, res) => {
